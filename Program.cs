...
namespace ConsoleApp1
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("9. Удалить линейно зависимые строки матрицы");
            Console.WriteLine("10. Удалить линейно зависимые строки квадратной матрицы");
            Console.WriteLine("11. Нахождение обратной матрицы");
            ...
            switch (n)
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    Matrix X = new Matrix(3, 4, 1, 10);
                    X.ShowMatrix();
                    Console.WriteLine();
                    X.Show_Gauss();
                    break;
                case 10:
                    SquareMatrix Y = new SquareMatrix(3, "keyboard");
                    Y.ShowMatrix();
                    if (Y.Checking_determinant() == 0)
                    {
                        Y.Show_Gauss();
                    }
                    else
                    ...
                    break;
                case 11:
                    InverseMatrix IR2 = new InverseMatrix(3, 1);
                    IR2.Inverse_matrix();
                    break;
            }
        }
